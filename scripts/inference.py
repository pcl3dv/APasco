...
from apasco.models.unet_2d_condition import UNet2DConditionModel
from apasco.models.unet_3d import UNet3DConditionModel
from apasco.utils.config import filter_non_none
from apasco.utils.util import tensor_to_video
...
def inference_process(args: argparse.Namespace):
    ...
    audio_emb = process_audio_emb(audio_emb) #[384, 5, 12, 768] 384 is audio lenth
    #import pdb; pdb.set_trace()
    source_image_pixels = source_image_pixels.unsqueeze(0) #[3, 512, 512] ->[1,3, 512, 512]
    source_image_face_region = source_image_face_region.unsqueeze(0) #[3, 512, 512] ->[1,3, 512, 512]
    source_image_face_emb = source_image_face_emb.reshape(1, -1) # (512,) -> (1, 512)
