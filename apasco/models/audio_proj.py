...
class AudioProjModel(ModelMixin):
    ...
    def __init__(
        ...
        self.proj1 = nn.Linear(self.input_dim, intermediate_dim) # 5*12*768 -> 512
        self.proj2 = nn.Linear(intermediate_dim, intermediate_dim) # 512 -> 512
        self.proj3 = nn.Linear(intermediate_dim, context_tokens * output_dim) #512 -> 32*768
    ...
    def forward(self, audio_embeds):
        ...
        return context_tokens #[batch_size,video_length,32,768]
